...
// 1.
var now = new Date();
var next  = new Date(2018,11,1,9,0,0);

if(next > now) {
	var raznost  = next - now;
	document.write("До первого декаюбря осталось - " + parseInt(raznost/(1000*60*60*24)) + ' - дней');
	document.write("<br />До первого декаюбря осталось - " + parseInt(raznost/(1000*60*60)) + ' - часов');
}
else {
